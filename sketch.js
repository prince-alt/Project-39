...
bg = createSprite(width/2,height-200,600,300);
 bg.addImage(bga);
  bg.scale = 1;
  bg.velocityX = -6;
...
background("red");
  ...
  bg.x = 300;
    ...
    camera.position.y = invisibleground.y-100;
  ...
  fill("red");
  text("Survival Time :" + survivaltime,width-150,200);
  
  text("Bananas :" + score,width/10,200);
}
...
obstacle.addImage(obstacleimage);
 obstacle.y = Math.round(random(310,400));
  obstacle.scale = 0.2;
